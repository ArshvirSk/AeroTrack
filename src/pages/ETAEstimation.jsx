...
const ETAEstimation = () => {
  ...
  // Calculate distance between airports (simplified version)
  const calculateDistance = (origin, destination) => {
    // This is a simplified calculation for demo purposes
    // In a real app, you would use the Haversine formula with actual coordinates
    const distances = {
      "Mumbai-Delhi": 1148,
      "Delhi-Mumbai": 1148,
      "Mumbai-Bangalore": 842,
      "Bangalore-Mumbai": 842,
      "Delhi-Bangalore": 1740,
      "Bangalore-Delhi": 1740,
      "Chennai-Kolkata": 1366,
      "Kolkata-Chennai": 1366,
      "Delhi-Kolkata": 1305,
      "Kolkata-Delhi": 1305,
    };

    const key = `${origin.city}-${destination.city}`;
    return distances[key] || Math.floor(Math.random() * 1000) + 500; // Fallback to random distance
  };
